...
| P2-G | Structured Human Interface (ask_information/ask_judgment/request_approval/request_action) | P1-E, P2-F | company_ops/human_interface.py, tests/test_human_interface.py, company-ops/hermes/SOUL.md | 2 | opencode | in_progress | P2-F landed+verified done; dispatched 2026-09-06 to opencode/mimo-v2.5-free with full design spec (Discord REST via urllib, search-before-ask only on ask_information, completion wrapper, reply-matching loop explicitly deferred/out of scope) |
