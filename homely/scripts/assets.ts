 ...
 *   2. Validate the furniture catalog manifest against the catalog schema
 ...
 *      referenced file must exist under assets/ (no .glb/.obj files are
 *      committed yet — the field is for future model authors).
 *   3. Sync `assets/` (catalog.json, textures, models/) into Vite's public dir
