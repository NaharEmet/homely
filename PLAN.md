...
| U1 | ui-layout-shell | B9 | homely/index.html + homely/src/style.css + homely/src/main.ts | clone-dev | clone-dev | review | SH3D-style split layout: menu bar, toolbar row, side-by-side plan+3d panels, status bar. Responsive CSS grid. Dark theme option. |
