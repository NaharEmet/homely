...
| B7 | top-camera-follower | B5 | homely/src/core | clone-dev | | todo | Port SH3D HomeController3D$TopCameraState (HomeController3D.java:823-1330): top camera follows whole-home bounds on item add/delete + property changes. Full algorithm + numeric verification in docs/behaviours/sh3d-camera-and-export.md. Must reproduce driver-observed positions for the 4-wall script exactly ((50,1050,1010,-180) fresh → (350,1250,1125) final). |
