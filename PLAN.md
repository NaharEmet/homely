...
| C8 | comparator-null-normalize | C3 | equivalence/eq/comparators | harness-dev | | todo | Deep-diff must treat absent key == null value (driver golden uses null for e.g. wall arcExtent/heightAtEnd/levelRef/sideColors, home name, cameras.*.fixedSize; homely omits the keys). ~14 false positives in live run 20260826-105922. Add tests; keep real null-vs-value diffs failing. |
