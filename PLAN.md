...
| U4 | ui-3d-polish | U1 | homely/src/view3d/scene.ts + homely/src/view3d/view.ts | clone-dev | clone-dev | review | 3D view polish: wall side textures (leftSideColor/rightSideColor), floor+ceiling for rooms, shadow mapping, better ground plane with grid lines, orbit controls (orbit/pan/zoom), ambient occlusion hint, fog for distance. |
