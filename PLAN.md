...
| U5 | ui-properties | U3,U2 | homely/src + homely/index.html | clone-dev | clone-dev | review | Properties panel: right sidebar shows selected object properties (wall: coords/thickness/height, room: area/perimeter, furniture: name/dimensions). Live updates on selection change. |
